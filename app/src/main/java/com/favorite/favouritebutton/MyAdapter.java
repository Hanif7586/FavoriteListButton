...
import com.favorite.favouritebutton.ui.FavoriteModel;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.listimg.setImageResource(model.img);
        ...
        holder.iv_favorite.setOnClickListener(view -> {
            ...
            if (isCurrentlyFavorite) {
                ...
                favoriteDao.insertAllData(new FavoriteModel(model.id, model.hindi, model.english,model.img));
                holder.iv_favorite.setImageResource(R.drawable.ic_favorite);
            }
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            listimg=view.findViewById(R.id.listimgid);
